...
from utils.dataloaders import create_single_threaded_dataloader
from train import *
...
#       ===============================================================
    ...
    def train_dataloader(self) -> DataLoader:
        return create_single_threaded_dataloader(pkl.load(open("train_path.pkl", "rb")), 512, 16, 32)

    def val_dataloader(self) -> Union[DataLoader, List[DataLoader]]:
        return create_single_threaded_dataloader(pkl.load(open("val_path.pkl", "rb")), 512, 1, 32)
...
#         self.train_loader, self.train_dataset = create_single_threaded_dataloader(
#             self.train_data,
#             self.patch_size,
...
#                 break
#
#         self.val_loader = create_single_threaded_dataloader(
#             self.val_data,
#             self.patch_size,
